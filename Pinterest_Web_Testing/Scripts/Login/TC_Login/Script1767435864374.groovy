...
WebUI.setText(findTestObject('Object Repository/Login/Login/input_Email_email'), Email)

WebUI.setText(findTestObject('Object Repository/Login/Login/input_Password'), Password)
