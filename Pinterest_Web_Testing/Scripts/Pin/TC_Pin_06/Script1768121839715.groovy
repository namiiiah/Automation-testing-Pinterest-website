...
WebUI.click(findTestObject('Pin/Pin_04_05_06/button_SaveInBoard'))

WebUI.verifyTextPresent('Saved', false)

WebUI.refresh()

WebUI.click(findTestObject('Pin/Pin_04_05_06/button_MoreBoard'))

WebUI.click(findTestObject('Pin/Pin_04_05_06/button_SaveInBoard'))

WebUI.verifyTextPresent('Already saved', false)
